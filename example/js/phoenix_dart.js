 ...
 * @private
 */
Push.prototype.matchReceive = function ({ status, response, ref }) {
...
/**
  ...
  * @returns {Push}
  */
Channel.prototype.join = function (timeout = this.timeout) {
  if (this.joinedOnce) {
 ...
 * @returns {Push}
 */
Channel.prototype.push = function (event, payload, timeout = this.timeout) {
  if (!this.joinedOnce) {
 ...
 * @returns {Push}
 */
Channel.prototype.leave = function (timeout = this.timeout) {
  this.rejoinTimer.reset()
 ...
 * @private
 */
Channel.prototype.isLifecycleEvent = function (event) { return CHANNEL_LIFECYCLE_EVENTS.indexOf(event) >= 0 }
 ...
 * @private
 */
Channel.prototype.rejoin = function (timeout = this.timeout) {
 ...
 * @private
 */
Channel.prototype.trigger = function (event, payload, ref, joinRef) {
 ...
 */
Socket.prototype.hasLogger = function () { return this.logger !== null }
...
Socket.prototype.teardown = function (callback, code, reason) {
  if (this.conn) {
...
Socket.prototype.abnormalClose = function (reason) {
  this.closeWasClean = false
